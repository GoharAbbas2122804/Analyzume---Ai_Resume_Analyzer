...
const Upload = () => {
    ...
    // This is the corrected handleAnalyze function with proper async declaration
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File  }) => {
        ...
        try {
            ...
            try {
                ...
                setStatusText('Error: Failed to process analysis results');
                return;
            }
            ...
            // Reset processing state only if there was an error
            // Don't reset if analysis completed successfully (to avoid interfering with navigation)
